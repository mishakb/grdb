...
//-----------------------------------------------------------------------------
	...
	String Spaces = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;";
        ...
        HtmlAnchor  aClear = new HtmlAnchor("",
                            new HtmlText("<b>Clear Results</b>\n"),
                            ServletAddress);

        String sListAllMetricsLink = ServletAddress + "?" +
                                   GRDBProtocol.COMMAND + "=" +
                                   GRDBProtocol.LIST_ALL;
        HtmlAnchor  aListAllMetrics = new HtmlAnchor("",
                                    new HtmlText("<b>List All</b>\n"),
                                    sListAllMetricsLink);

        String sPrivateInputLink = ServletAddress + "?" +
                              GRDBProtocol.COMMAND + "=" +
                              GRDBProtocol.PRIVATE;
        HtmlAnchor  aPrivateInput = new HtmlAnchor("",
                               new HtmlText("<b>Private Input</b>\n"),
                               sPrivateInputLink);

        String sAbout = "/~postgres/aboutgrdb.html";
        //String sAbout = "/~postgres/aboutgrdb.html";
        HtmlAnchor  aAbout = new HtmlAnchor("",
                               new HtmlText("<b>Information</b>\n"),
                               sAbout);

        String sHow = "/~postgres/howgrdb.html";
        HtmlAnchor  aHow = new HtmlAnchor("",
                               new HtmlText("<b>Help</b>"),
                               sHow);

        String sPublicInput = "/~postgres/publicinput.html";
        HtmlAnchor  aPublicInput = new HtmlAnchor("",
                               new HtmlText("<b>Public Input</b>\n"),
                               sPublicInput);

        String sBuild = "/~postgres/build.html";
        HtmlAnchor  aBuild = new HtmlAnchor("",
                               new HtmlText("<b>Database</b>\n"),
                               sBuild);
//----------------------------------------------------------------------------
