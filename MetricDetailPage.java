...
public class MetricDetailPage extends HtmlPage
{
    public MetricDetailPage (String sServletAddress, MetricRecord record, int DisplayFullRecord)
    {
        ...
        sJavascript.append("{\n");
        sJavascript.append("document.forms.MetricDetail.Command.value" +
                                                        "= sAction;\n");
        ...
        HtmlText title = null;
        title = new HtmlText("Record Details for : "+
					record.getmetricname(), "H2");
...
//        body.addHtml("\n<BR>\n");
        ...
        // body.addHtml("<HR SIZE=2>");
         ...
         HtmlText LoadInCalculator = new HtmlText("<FORM ACTION=\"/servlet/GRDB2.GRDBServlet\" METHOD=\"POST\"> <INPUT TYPE=\"submit\" NAME=\"LoadButton\" VALUE=\"Mark To Load in Calculator\">  <INPUT TYPE=\"hidden\" NAME=\"Command\" VALUE=\"AddToMetricsList\" > <INPUT TYPE=\"hidden\" NAME=\"MetricToLoad\" VALUE=\""+record.getmetricname().trim()+"\" >  </FORM>\n" );
