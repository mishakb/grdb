...
public class PrivateInput extends HtmlPage {
    public PrivateInput (String sServletAddress) {
        ...
        String sNewMetricLink = sServletAddress + "?" + GRDBProtocol.COMMAND + "=" + GRDBProtocol.NEW;
        HtmlAnchor aNewMetric = new HtmlAnchor("", new HtmlText("Add a New Metric"), sNewMetricLink);
