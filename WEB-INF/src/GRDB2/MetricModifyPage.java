...
public class MetricModifyPage extends HtmlPage {
    public MetricModifyPage (String sServletAddress, MetricRecord record) {
        ...
        HtmlHead head = null;
        if (record != null) {
            head = new HtmlHead("Metric Modification Page, for Metric Name: " + record.getmetricname());
        }
        else {
        ...
        sJavascript.append("{\n");
        sJavascript.append("document.forms.MetricModify.Command.value" + "= sAction;\n");
        ...
        save.addParameter("onClick=doSubmit(\"" + GRDBProtocol.SAVE + "\")");
        HtmlInputButton delete = new HtmlInputButton("Delete", "Delete");
        delete.addParameter("onClick=doSubmit(\"" + GRDBProtocol.DELETE + "\")");
