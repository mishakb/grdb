...
*           
*
* Purpose: to define an adapted kind of html table.
*
* Revisions:
*
*
...
public class HtmlTableSpecial implements HtmlComponent
{
    private Vector vRows = new Vector();
    private Vector vParameters = new Vector();

    public HtmlTableSpecial ()      {   }
