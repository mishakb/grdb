...
public class MetricsSearchForm extends HtmlForm
{
    public MetricsSearchForm (String sServletAddress)
    {
        ...
        HtmlRadioButton searchKSHM =
                    new HtmlRadioButton("SearchParameter",
                                        "kshm",
                                        "Search by <a href=\"/~postgres/kshms.html\">KSHMS</a> (e.g. (13.24) p158)\n",
                                        false);

        HtmlRadioButton searchKeyword =
                    new HtmlRadioButton("SearchParameter",
                                        "Keyword",
                                        "Search by <a href=\"/~postgres/keyword.html\">Keyword</a> (e.g. Kruskal)\n", 
                                        true);
